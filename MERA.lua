...
id_server = io.popen("echo $SSH_CLIENT | awk '{ print $1}'"):read('*a')local AutoSet = function()
-------------------------------------------------------------------------------------------------------------- 
...
if text == 'السيرفر🗣️' and SudoBot(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/swrsmsb/MERA/master/MERA.lua')
